...
m1.long %>%
  mutate(as.factor.effectiveness. = paste0("Effectiveness = ", as.factor.effectiveness.)) %>%
  ggplot(aes(factor.rating., probability, col = as.factor.sideEffects.)) +
  geom_point() +
  facet_wrap(~ as.factor.effectiveness.) +
...
levels(m.df2.long$as.factor.effectiveness.) <- c("Ineffective","Marginally Effective","Moderately Effective","Considerably Effective","Highly Effective")
