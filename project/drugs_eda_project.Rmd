...
temp %>% 
  ...
  theme(plot.title = element_text(size = 14),
        panel.grid.major.y = element_blank()) 3+
...
m1.long$as.factor.sideEffects.f <- factor(m1.long$as.factor.sideEffects., levels = c("5","4","3","2","1"))
...
m1.long %>%
  ...
  labs(title = "Multinomial Logit Model Probabilities")+
